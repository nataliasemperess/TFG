...
: ${AMENT_CURRENT_PREFIX:="/TFG_ws/src/install/rmf_nayar"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmf_nayar/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmf_nayar/environment/path.sh"
